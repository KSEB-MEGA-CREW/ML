...
class SessionManager:
    ...
    def create_session(self, session_id: str, user_id: Optional[int] = None) -> Dict[str, Any]:
        """새 세션 생성"""
    ...
    def add_frame_result(self, session_id: str, frame_index: int, result: Dict[str, Any]):
    ...
    def get_recent_results(self, session_id: str, count: int = 10) -> List[Dict[str, Any]]:
        """최근 처리 결과 조회"""
